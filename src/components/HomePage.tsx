    ...
    <>
      ...
      <footer>
        ...
        <div className="footer-grid">
          ...
          {/* Mobile only (max-width 639px): paired with Visit. Web view keeps icons in footer bottom bar. */}
          <div className="footer-col footer-col--social reveal reveal-delay-3">
            <span className="label footer-col-label">Follow Us</span>
            <ul className="footer-social-rows">
              <li>
                <a
                  href="https://www.youtube.com/@hmbc860"
                  target="_blank"
                  ...
                  aria-label="YouTube @hmbc860"
                >
                  <span className="footer-social-row-icon" aria-hidden="true">
                  ...
                  <span className="footer-social-row-handle">@hmbc860</span>
                </a>
              </li>
              <li>
                <a
                  href="https://www.facebook.com/hmbc860"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-social-row"
                  aria-label="Facebook @hmbc860"
                >
                  <span className="footer-social-row-icon" aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
